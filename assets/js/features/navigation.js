...
// J'initialise toute la navigation. Cette fonction est appelée depuis app.js
// sur le DOMContentLoaded, donc je suis certain que le DOM existe.
export function initNavigation() {
    ...
    // Je bascule l'état ouvert/fermé de la sidebar. Pourquoi une fonction
    // interne ? Pour pouvoir l'appeler depuis le clic, le clavier et l'Escape
